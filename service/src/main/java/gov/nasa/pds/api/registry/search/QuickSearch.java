...
public class QuickSearch {
	final private static Object get(ConnectionContext connection, boolean justLatest, String index, String lidvid,
			String name) throws IOException, LidVidNotFoundException {
	...
	final public static String getValue(ConnectionContext connection, boolean justLatest, String lidvid, String name)
	...
	final public static String getValue(ConnectionContext connection, boolean justLatest, String index, String lidvid,
			String name) throws IOException, LidVidNotFoundException {
		return (String) QuickSearch.get(connection, justLatest, index, lidvid, name);
	}

	@SuppressWarnings("unchecked")
	final public static List<String> getValues(ConnectionContext connection, boolean justLatest, String lidvid,
			String name) throws IOException, LidVidNotFoundException {
		return (List<String>) QuickSearch.get(connection, justLatest, connection.getRegistryIndex(), lidvid, name);
	}

	@SuppressWarnings("unchecked")
	final public static List<String> getValues(ConnectionContext connection, boolean justLatest, String index,
