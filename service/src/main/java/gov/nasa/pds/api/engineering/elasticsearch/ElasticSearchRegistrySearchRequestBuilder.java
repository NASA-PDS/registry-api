...
public class ElasticSearchRegistrySearchRequestBuilder
{
    ...
    static public String[] excludes (List<String> fields)
    {
    	String[] exclude, 
    	        ex0 = new String[0], 
    	        exbp = {EntitytProductWithBlob.BLOB_PROPERTY},
    	...
    	if (fields.contains(EntitytProductWithBlob.BLOB_PROPERTY) 
    	        && fields.contains(EntitytProductWithBlob.JSON_BLOB_PROPERTY)) exclude = ex0;
