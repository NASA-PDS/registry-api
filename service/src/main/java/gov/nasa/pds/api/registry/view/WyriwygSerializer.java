...
final class WyriwygSerializer {
	...
	private static void writeJSON(WyriwygProduct product, Writer wr, ObjectMapper mapper, String indent)
			throws IOException {
		int n = 0;
		wr.write(indent + "{\n");
	...
	private static void writeRow(List<String> labels, WyriwygProduct product, Writer wr, ObjectMapper om)
			throws IOException {
