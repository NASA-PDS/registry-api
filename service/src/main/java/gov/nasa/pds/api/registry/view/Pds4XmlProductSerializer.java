...
public class Pds4XmlProductSerializer extends AbstractHttpMessageConverter<Pds4Product> {
	...
	protected void writeInternal(Pds4Product product, HttpOutputMessage outputMessage)
		...
		try {
			...
			this.logger.error("For XML serialization, the Product object must be extended as ProductWithXmlLabel: "
					+ e.getMessage());
		} catch (Exception e) {
	...
	static public void serialize(OutputStream stream, XMLStreamWriter writer, XmlMapper mapper, Pds4Product product)
