...
public class Pds4XmlProductTransformer extends Pds4ProductTransformer {

  private static final Logger log = LoggerFactory.getLogger(Pds4XmlProductTransformer.class);

  public Pds4XmlProductTransformer() {
    super(false);
  ...
  public List<PdsProperty> getRequestedFields(List<PdsProperty> userRequestFields) {
    ...
    fields.add(PdsPropertyConstants.XML_BLOB);
    return fields;
