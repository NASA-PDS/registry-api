...
public class SwaggerJavaTransmuter extends SwaggerJavaDeprecatedTransmuter
	...
	protected ResponseEntity<Object> processs(EndpointHandler handler, URIParameters parameters) {
		...
		try {
			...
			log.info("Transmuter processing of request took: " + (System.currentTimeMillis() - begin) + " ms");
		}
	}
	...
	@Override
	public ResponseEntity<Object> bundlesLidvidCollections(String identifier, @Valid List<String> fields,
			@Min(0) @Valid Integer limit, @Valid List<String> sort, @Min(0) @Valid Integer start) {
		// TODO Auto-generated method stub
	...
	@Override
	public ResponseEntity<Object> bundlesLidvidCollectionsAll(String identifier, @Valid List<String> fields,
			@Min(0) @Valid Integer limit, @Valid List<String> sort, @Min(0) @Valid Integer start) {
		// TODO Auto-generated method stub
	...
	@Override
	public ResponseEntity<Object> bundlesLidvidCollectionsLatest(String identifier, @Valid List<String> fields,
			@Min(0) @Valid Integer limit, @Valid List<String> sort, @Min(0) @Valid Integer start) {
		// TODO Auto-generated method stub
	...
	@Override
	public ResponseEntity<Object> collectionsLidvidBundles(String identifier, @Valid List<String> fields,
			@Min(0) @Valid Integer limit, @Valid List<String> sort, @Min(0) @Valid Integer start) {
		// TODO Auto-generated method stub
	...
	@Override
	public ResponseEntity<Object> collectionsLidvidProducts(String identifier, @Valid List<String> fields,
			@Min(0) @Valid Integer limit, @Valid List<String> sort, @Min(0) @Valid Integer start) {
		// TODO Auto-generated method stub
	...
	@Override
	public ResponseEntity<Object> collectionsLidvidProductsAll(String identifier, @Valid List<String> fields,
			@Min(0) @Valid Integer limit, @Valid List<String> sort, @Min(0) @Valid Integer start) {
		// TODO Auto-generated method stub
	...
	@Override
	public ResponseEntity<Object> collectionsLidvidProductsLatest(String identifier, @Valid List<String> fields,
			@Min(0) @Valid Integer limit, @Valid List<String> sort, @Min(0) @Valid Integer start) {
		// TODO Auto-generated method stub
	...
	@Override
	public ResponseEntity<Object> productsLidividBundlesAll(String identifier, @Valid List<String> fields,
			@Min(0) @Valid Integer limit, @Valid List<String> sort, @Min(0) @Valid Integer start) {
		// TODO Auto-generated method stub
	...
	@Override
	public ResponseEntity<Object> productsLidvidBundlesLatest(String identifier, @Valid List<String> fields,
			@Min(0) @Valid Integer limit, @Valid List<String> sort, @Min(0) @Valid Integer start) {
		// TODO Auto-generated method stub
	...
	@Override
	public ResponseEntity<Object> productsLidvidCollections(String identifier, @Valid List<String> fields,
			@Min(0) @Valid Integer limit, @Valid List<String> sort, @Min(0) @Valid Integer start) {
		// TODO Auto-generated method stub
	...
	@Override
	public ResponseEntity<Object> productsLidvidCollectionsAll(String identifier, @Valid List<String> fields,
			@Min(0) @Valid Integer limit, @Valid List<String> sort, @Min(0) @Valid Integer start) {
		// TODO Auto-generated method stub
	...
	@Override
	public ResponseEntity<Object> productsLidvidCollectionsLatest(String identifier, @Valid List<String> fields,
			@Min(0) @Valid Integer limit, @Valid List<String> sort, @Min(0) @Valid Integer start) {
		// TODO Auto-generated method stub
	...
	public ResponseEntity<Object> classList(String propertyClass, @Valid List<String> fields,
			@Valid List<String> keywords, @Min(0) @Valid Integer limit, @Valid String q, @Valid List<String> sort,
			@Min(0) @Valid Integer start) {
		// TODO Auto-generated method stub
	...
	@Override
	public ResponseEntity<Object> classMemberOf(String propertyClass, String identifier, @Valid List<String> fields,
			@Min(0) @Valid Integer limit, @Valid List<String> sort, @Min(0) @Valid Integer start) {
		// TODO Auto-generated method stub
	...
	@Override
	public ResponseEntity<Object> classMemberOfOf(String propertyClass, String identifier, @Valid List<String> fields,
			@Min(0) @Valid Integer limit, @Valid List<String> sort, @Min(0) @Valid Integer start) {
		// TODO Auto-generated method stub
	...
	@Override
	public ResponseEntity<Object> classMemberOfOfVers(String propertyClass, String identifier, String versions,
			@Valid List<String> fields, @Min(0) @Valid Integer limit, @Valid List<String> sort,
			@Min(0) @Valid Integer start) {
		// TODO Auto-generated method stub
		return super.classMemberOfOfVers(propertyClass, identifier, versions, fields, limit, sort, start);
	}

	@Override
	public ResponseEntity<Object> classMemberOfVers(String propertyClass, String identifier, String versions,
			@Valid List<String> fields, @Min(0) @Valid Integer limit, @Valid List<String> sort,
			@Min(0) @Valid Integer start) {
		// TODO Auto-generated method stub
	...
	@Override
	public ResponseEntity<Object> classMembers(String propertyClass, String identifier, @Valid List<String> fields,
			@Min(0) @Valid Integer limit, @Valid List<String> sort, @Min(0) @Valid Integer start) {
		// TODO Auto-generated method stub
	...
	@Override
	public ResponseEntity<Object> classMembersMembersVers(String propertyClass, String identifier, String versions,
			@Valid List<String> fields, @Min(0) @Valid Integer limit, @Valid List<String> sort,
			@Min(0) @Valid Integer start) {
		// TODO Auto-generated method stub
		return super.classMembersMembersVers(propertyClass, identifier, versions, fields, limit, sort, start);
	}

	@Override
	public ResponseEntity<Object> classMembersVers(String propertyClass, String identifier, String versions,
			@Valid List<String> fields, @Min(0) @Valid Integer limit, @Valid List<String> sort,
			@Min(0) @Valid Integer start) {
		// TODO Auto-generated method stub
