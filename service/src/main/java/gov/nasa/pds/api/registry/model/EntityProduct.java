...
public class EntityProduct {
	public static final String[] JSON_PROPERTIES = new String[] { "lidvid", "title", "product_class",
			...
			"ref_lid_instrument_host", "ref_lid_instrument", "ref_lid_investigation", "ref_lid_target", "vid",
			"ops:Label_File_Info/ops:file_ref", "ops:Tracking_Meta/ops:archive_status" };
