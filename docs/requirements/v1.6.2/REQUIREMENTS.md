...
This requirement is not impacted by the current version
## As a user, I want to search all PDS4 properties by keyword ([#685](https://github.com/NASA-PDS/registry-api/issues/685)) 


This requirement is not impacted by the current version
## As a Data Engineer or Tool Developer, I want to check if a label or data product has been successfully registered using its checksum ([#692](https://github.com/NASA-PDS/registry-api/issues/692)) 


This requirement is not impacted by the current version
## As a developer/beta-tester, I want to be able to test the latest version of the API from the develop branch ([#694](https://github.com/NASA-PDS/registry-api/issues/694)) 


This requirement is not impacted by the current version
## As a user, I want to query nested arrays using predicate filters ([#703](https://github.com/NASA-PDS/registry-api/issues/703)) 


This requirement is not impacted by the current version
## As a user, I want to search nested attributes using predicate-based path filtering ([#704](https://github.com/NASA-PDS/registry-api/issues/704)) 


This requirement is not impacted by the current version
## As a user, I want the API to answer gracefully when OpenSearch unable to answer ([#707](https://github.com/NASA-PDS/registry-api/issues/707)) 


This requirement is not impacted by the current version
## As an API consumer, I want to know how the CSV array serialization format ([#711](https://github.com/NASA-PDS/registry-api/issues/711)) 
...
This requirement is not impacted by the current version
## As a user, I want to have a consistent wildcard syntax in the API ([#725](https://github.com/NASA-PDS/registry-api/issues/725)) 


This requirement is not impacted by the current version
## As a user, I want to get a subset of relevant metadata fields by default, instead of all available metadata fields ([#726](https://github.com/NASA-PDS/registry-api/issues/726)) 


This requirement is not impacted by the current version
## As a user, I want to know why a lidvid can not be found and be redirected where I should search instead ([#739](https://github.com/NASA-PDS/registry-api/issues/739)) 


This requirement is not impacted by the current version
## As an API user, I want to query all versions using a query parameter ([#752](https://github.com/NASA-PDS/registry-api/issues/752)) 


This requirement is not impacted by the current version
## As a data user, I want to see total collection size and member count in API responses ([#755](https://github.com/NASA-PDS/registry-api/issues/755)) 


This requirement is not impacted by the current version
## As a user, I want to use POST to send my requests ([#756](https://github.com/NASA-PDS/registry-api/issues/756)) 


This requirement is not impacted by the current version
## As a developer, I want to run the integration tests locally and have github actions do it ([#759](https://github.com/NASA-PDS/registry-api/issues/759)) 


This requirement is not impacted by the current version
## As a data user, I want to search for Context products via the PDS Search API so that I can discover mission and instrument context for planetary data products ([#770](https://github.com/NASA-PDS/registry-api/issues/770)) 


This requirement is not impacted by the current version
## As a user, I want to receive API search results in VOTable format ([#771](https://github.com/NASA-PDS/registry-api/issues/771)) 


This requirement is not impacted by the current version
## As a data user, I want to search and filter on XML attribute values from PDS4 labels ([#789](https://github.com/NASA-PDS/registry-api/issues/789)) 
